...
Original file is located at
    https://colab.research.google.com/drive/1Lxp0tjxplP0kSOByLdCIBEn2ksRPejur
"""

!pip install transformers torch gradio pymupdf -q
...
def generate_response(prompt, max_new_tokens=600):
    ...
    # Decode only the newly generated tokens (avoid repeating the prompt)
